...
#start message
START_MSG = os.environ.get("START_MESSAGE", "Hello {first} {username} i am porn Bot(will work in 2-3 days)    This bot is Based on Pyrogram.. and its libraries are changed so i also have to change bot accordingly. bot will come back in few days till now join our whatsapp group https://chat.whatsapp.com/CajQBYZsW3iH8LX4sRMN1l")
try:
    ADMINS=[]
